...
global.owner = process.env.OWNER_NUMBER  || '2348184670229' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7U9ikBDD#xKKWAXyfjgWIcY1ILrReOmvoC27bmlcuDIUOckaDsCU' ,
